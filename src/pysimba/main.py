...
def main():
    ...
    if choice == "1":
        ...
        print(
            "Note: To add a new measurement you will need access to the directory 'data/add/'. There you will have to put your pickle file containing the dictionary you want to add. If that is not the case, please do so."
        )
        print(
            "______________________________________________________________________________________"
        )
