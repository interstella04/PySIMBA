...
class Grab:
    ...
    def Grabber():
        ...
        Tools.StoreInPickle(theory_dictionary_expx3, BASE_DIR / 'data/theory/theory_dictionary_expx3')
        Tools.StoreInPickle(theory_dictionary_expx4, BASE_DIR / 'data/theory/theory_dictionary_expx4')
        Tools.StoreInPickle(theory_dictionary_gaussx3, BASE_DIR / 'data/theory/theory_dictionary_gaussx3')
        ...
        Tools.StoreInPickle(theory_dictionary_SSF27, BASE_DIR / 'data/theory/theory_dictionary_SSF27')
