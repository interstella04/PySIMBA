...
class Grab:
    ...
    def GrabMeasurement(Tag, Label, location):
        print("Grab %s" % Tag)
    ...
    def GrabMoments():
        ...
        Fmn_moments = {"expx3": dict, "expx4": dict, "gaussx3": dict}
        ...
        for name in names:
            ...
            for i, line in enumerate(file):
                ...
                if line.startswith(
                    "%s" % strip_string
                ):  # skips line starting with # moment or # bin depending on the file
                    line.strip()
                    bins.append(count)
                    count += 1
                    continue
    ...
    def Grabber():
        ...
        Tools.StoreInPickle(
            theory_dictionary_expx3, BASE_DIR / "data/theory/theory_dictionary_expx3"
        )
        Tools.StoreInPickle(
            theory_dictionary_expx4, BASE_DIR / "data/theory/theory_dictionary_expx4"
        )
        Tools.StoreInPickle(
            theory_dictionary_gaussx3,
            BASE_DIR / "data/theory/theory_dictionary_gaussx3",
        )
        ...
        Tools.StoreInPickle(
            theory_dictionary_SSF27, BASE_DIR / "data/theory/theory_dictionary_SSF27"
        )
        ...
        Tools.StoreInPickle(hist_nom, BASE_DIR / "data/theory/hist_nom")
